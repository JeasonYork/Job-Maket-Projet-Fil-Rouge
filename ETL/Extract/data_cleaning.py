...
# TODO: dans les fichiers a prendre en compte garder les endswith num_semaime.json
# TODO: Adapter les différentes fonctions
...
log_file_path = log_dir / "transformation_log.txt"
# Ouvrir le fichier de log
log_file = open(log_file_path, "w", encoding="utf-8")


for filename in os.listdir(data_dir):
    if filename.endswith(f"{week_number}.json"):
        ...
        output_filepath = os.path.join(data_dir, f"wttj_database_{week_number}.json")
