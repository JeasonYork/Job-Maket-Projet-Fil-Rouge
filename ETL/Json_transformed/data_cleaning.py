...
log_file_path = "/home/ubuntu/ETL/transformation_log.txt"
    ...
    if filename.endswith(".json"):
        ...
        for entry in data:
            ...
            if 'location' in entry:
                ...
                print(f"Avant transformation: {before_location}", file=log_file)  # Rediriger vers le fichier de log
                print(f"Après transformation: {after_location}", file=log_file)   # Rediriger vers le fichier de log
            else:
                entry['location'] = None

            # Si 'details' n'existe pas dans l'entrée, le créer
            if "details" not in entry or entry["details"] is None:
                entry["details"] = {}

            details = entry["details"]

            # Déplacer les variables spécifiques vers 'details'
            ...
            # Transformer les listes en chaînes si nécessaire (facultatif selon besoin)
            def transform_list_to_string(value):
