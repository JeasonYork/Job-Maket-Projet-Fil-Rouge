...
JSON_TEMP_DIR = '/home/ubuntu/ETL/Json_temp'
JSON_SCRAPING_DIR = '/home/ubuntu/ETL/Json_scraping'
JSON_TRANSFORMED_DIR = '/home/ubuntu/ETL/Json_transformed'
...
def clean_json(file_path, **kwargs):
    ...
    if is_file_stable(file_path):
        ...
        subprocess.run(['python', '/home/ubuntu/ETL/Transform/data_cleaning.py', file_path, JSON_TRANSFORMED_DIR], check=True)
...
def bulk_load(**kwargs):
    ...
    subprocess.run(['python', '/home/ubuntu/ETL/Load/bulk_script.py', JSON_TRANSFORMED_DIR], check=True)
